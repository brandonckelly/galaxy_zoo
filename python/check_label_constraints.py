...
TOLERANCE = 0.01  # 0.01 # only absolute errors greater than this are reported.

if __name__ == "__main__":

    if len(sys.argv) < 2:
        print 'Syntax: python check_label_constraints.py solutions_file.csv'
        exit()

    TRAIN_LABELS_PATH = data_dir + sys.argv[1]
